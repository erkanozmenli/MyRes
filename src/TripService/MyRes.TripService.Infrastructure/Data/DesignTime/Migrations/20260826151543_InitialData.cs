        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkflowCompletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarReservation_TripItem_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightReservation_TripItem_Id",
                        column: x => x.Id,
                        principalTable: "TripItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HotelReservation_TripItem_Id",
                        column: x => x.Id,
                        principalTable: "TripItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Flight_FlightReservation_TripItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousSegmentId = table.Column<int>(type: "int", nullable: true),
                    FromAirport = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    ToAirport = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightSegment_FlightSegment_PreviousSegmentId",
                        column: x => x.PreviousSegmentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightSegment_PreviousSegmentId",
                table: "FlightSegment",
