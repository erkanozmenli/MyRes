...
namespace MyRes.TripService.Api
{
    public static class ApiExtensions
    {
        ...
        private static IEndpointRouteBuilder MapSystemEndpoints(this IEndpointRouteBuilder endpoints, IConfiguration configuration)
        {
            ...
            endpoints.MapGet("debug/claim", (ICurrentIdentityAccessor accessor) =>
            {
                return new
                {
                    UserId = accessor.Identity.UserId,
                    Username = accessor.Identity.Username,
                    Email = accessor.Identity.Email,
                    ClientId = accessor.Identity.ClientId,
                };
            });
